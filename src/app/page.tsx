...
export default function SavageMathPage() {
  ...
  return (
    <main 
    className="flex min-h-screen flex-col items-center justify-start md:justify-center p-4 pt-16 sm:p-8 md:p-12 text-foreground transition-colors duration-1000 ease-in-out relative"
    ...
    >
      ...
      <footer className="absolute bottom-4 w-full text-center text-muted-foreground text-sm">
        <div className="inline-flex items-center justify-center gap-2">
          ...
          <a href="https://3xabrand.vercel.app" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1 hover:text-foreground transition-colors -mt-1">
          <svg xmlns="http://www.w3.org/2000/svg" version="1.0" width="60.000000pt" height="27.000000pt" viewBox="0 0 450.000000 202.000000" preserveAspectRatio="xMidYMid meet">
            ...
            <g transform="translate(-80,170) scale(0.050000,-0.050000)" fill="#cca2a2" stroke="none">
            ...
            <path d="M6010 1265 c-42 -118 -96 -262 -122 -320 l-46 -105 249 0 248 0 -42 105 c-23 58 -77 200 -121 315 -44 116 -82 212 -85 215 -3 3 -39 -91 -81 -210z" fill="#cca2a_A"/>
